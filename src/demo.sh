...
python main.py --model EDSR --data_train yh_sr_exp1 --data_test yh_sr_exp1 --scale 2 --patch_size 48 --save med_exp1_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --n_colors 1 --batch_size 16 --reset
# summary
