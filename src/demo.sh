...
python main.py --data_test yh_sr_exp2 --scale 2 --pre_train /home/v5/yh/Eclipse_ws/edsr/study_edsr/experiment/med_exp2_x2/model/model_latest.pt --test_only --save_results --dir_demo "../test_med_exp2" --n_resblocks 32 --n_feats 256 --res_scale 0.1 --n_colors 1 --rgb_range 5119 --patch_size 48
