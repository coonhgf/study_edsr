...
python main.py --data_test Demo --scale 2 --pre_train /home/v5/yh/Eclipse_ws/edsr/study_edsr/experiment/med_exp1_x2/model/model_best.pt --test_only --save_results --dir_demo "../test_med_exp1"
